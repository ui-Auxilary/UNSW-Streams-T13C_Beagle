...
def test_single_message(clear_data, create_users, create_channel):
    ...
    time = json.loads(search.text)['time_created']
...
def test_no_messages_from_query(clear_data, create_users, create_channel):
    token, user, _, _, _, _, = create_users
    channel_id, _ = create_channel
    query_str = 'imagine'
...
def test_single_message_substring(clear_data, create_users, create_channel):
    token, user, _, _, _, _, = create_users
    channel_id, _ = create_channel
    message = "imagine"
...
def test_channel_and_dm_query(clear_data, create_users, create_channel, create_dms):
    token, user, _, _, _, _, = create_users
    channel_id, _ = create_channel
    ...
    assert get_search == [{'message_id': message_id, 'u_id': user, 'message': message, 'time_created': time, 'reacts': {}, 'is_pinned': False},
                          {'message_id': dm_message_id, 'u_id': user, 'message': message, 'time_created': time, 'reacts': {}, 'is_pinned': False}]

def test_multiple_channels_and_dms(clear_data, create_users, create_channel, create_dms):
    token_1, user_1, token_2, user_2, _, _, = create_users
    channel_id_1, channel_id_2 = create_channel
    ...
    assert get_search == [{'message_id': message_id_1, 'u_id': user_1, 'message': message_1, 'time_created': time, 'reacts': {}, 'is_pinned': False},
                          {'message_id': dm_message_id_1, 'u_id': user_2, 'message': message_2, 'time_created': time, 'reacts': {}, 'is_pinned': False},
                          {'message_id': dm_message_id_2, 'u_id': user_3, 'message': message_4, 'time_created': time, 'reacts': {}, 'is_pinned': False}]


# ___TEST VALID INPUT___ #


def test_query_too_short(clear_data, create_users, create_channel):
    token, user, _, _, _, _, = create_users
    channel_id, _ = create_channel
    query_str = ''
...
def test_query_too_long(clear_data, create_users, create_channel):
    token, user, _, _, _, _, = create_users
    channel_id, _ = create_channel
